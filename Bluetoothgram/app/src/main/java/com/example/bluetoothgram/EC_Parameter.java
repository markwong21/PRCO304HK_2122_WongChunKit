...
public class EC_Parameter {
    ...
    EC_Parameter(String name) {
        this.name = name;
    }

    public static final EC_Parameter secp160k1 = new EC_Parameter("secp160k1");
    public static final EC_Parameter secp224k1 = new EC_Parameter("secp224k1");

    private static final Map<String, EC_Parameter> PARAMS = new HashMap<String, EC_Parameter>();
    ...
    static EC_Parameter getParams(String name) {
    ...
    // Get the value of point from the ECC
